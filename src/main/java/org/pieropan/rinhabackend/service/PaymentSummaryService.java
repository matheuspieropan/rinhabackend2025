...
import org.pieropan.rinhabackend.dto.PaymentProcessor;
...
public class PaymentSummaryService {
    ...
    private final MongoClient mongoClient = MongoProvider.getInstance().getMongoClient();
    ...
    public PaymentSummaryResponse paymentSummary(String from,
        ...
        MongoCollection<Document> collection = mongoClient.getDatabase("rinhabackend").getCollection("payments");
